...
class _TimbradoPageState extends State<TimbradoPage> {
  ...
  void _eliminarTimbrado(Timbrado timbrado) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Confirmar eliminación'),
        content: Text('¿Está seguro de eliminar el timbrado ${timbrado.timbrado}?'),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final exito = await _timbradoCrud.eliminarTimbrado(timbrado.id_timbrado!);
              Navigator.pop(context);
              ...
              if (exito) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Timbrado eliminado exitosamente'),
                    backgroundColor: Colors.green,
                  ),
                );
              } else {
                _mostrarError('Error al eliminar el timbrado');
              }
            },
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () => _eliminarTimbrado(tim),
                                            tooltip: 'Eliminar',
                                          ),
                                        ],
                                      ),
