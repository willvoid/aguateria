...
class _ConceptosPageState extends State<ConceptosPage> {
  ...
  void _eliminarConcepto(Concepto concepto) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final exito = await _conceptoCrud.eliminarConcepto(concepto.id!);
              Navigator.pop(context);
              ...
              if (exito) {
                ...
                _mostrarError('Error al eliminar el concepto');
              }
            },
